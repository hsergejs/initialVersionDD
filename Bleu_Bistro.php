...
<? if (stristr($_SERVER['PHP_SELF'],"crossfire.php")) { 
...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='Bleu_Bistro'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='Bleu_Bistro'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='Bleu_Bistro' ORDER BY id ASC") or die("Error 3");
