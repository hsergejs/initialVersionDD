...
<? if (stristr($_SERVER['PHP_SELF'],"SoupDragon.php")) { 
...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='SoupDragon'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='SoupDragon'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='SoupDragon' ORDER BY id ASC") or die("Error 3");
