...
<? if (stristr($_SERVER['PHP_SELF'],"one_pico.php")) { 
...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='one_pico'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='one_pico'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='one_pico' ORDER BY id ASC") or die("Error 3");
