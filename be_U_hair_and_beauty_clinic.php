...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='be_U_hair_and_beauty_clinic'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='be_U_hair_and_beauty_clinic'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='be_U_hair_and_beauty_clinic' ORDER BY id ASC") or die("Error 3");
...
$sh_name = 'be_U_hair_and_beauty_clinic';
