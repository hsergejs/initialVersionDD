<?php define( '_NO', 1 ); ?>
<? if (stristr($_SERVER['PHP_SELF'],"Siam_Thai_Restaurants.php")) { 
      
    die("We apologise, but this company has been removed from our catalogues."); 
}
?>
<? include ("block/bd.php");
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='Siam_Thai_Restaurants'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='Siam_Thai_Restaurants'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='Siam_Thai_Restaurants' ORDER BY id ASC") or die("Error 3");
