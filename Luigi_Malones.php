...
<? if (stristr($_SERVER['PHP_SELF'],"Luigi_Malones.php")) { 
...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='Luigi_Malones'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='Luigi_Malones'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='Luigi_Malones' ORDER BY id ASC") or die("Error 3");
