...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='Bewleys_Hotel_Dublin_Airport'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='Bewleys_Hotel_Dublin_Airport'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='Bewleys_Hotel_Dublin_Airport' ORDER BY id ASC") or die("Error 3");
...
$sh_name = 'Bewleys_Hotel_Dublin_Airport';
