...
<? if (stristr($_SERVER['PHP_SELF'],"Pearl_Treatment_Centres.php")) { 
      
    die("We apologise, but this company has been removed from our catalogues."); 
}
?>

<? include ("block/bd.php");
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='Pearl_Treatment_Centres'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='Pearl_Treatment_Centres'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='Pearl_Treatment_Centres' ORDER BY id ASC") or die("Error 3");
...
$sh_name='Pearl_Treatment_Centres';
