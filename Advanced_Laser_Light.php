...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='Advanced_Laser_Light'",$db);
if (!$result)
{
...
<link rel="stylesheet" href="galery/css/lightbox.css" type="text/css" media="screen" />
<script src="galery/js/prototype.js" type="text/javascript"></script>
<script src="galery/js/scriptaculous.js?load=effects" type="text/javascript"></script>
<script src="galery/js/lightbox.js" type="text/javascript"></script>
</head>
<body>
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='Advanced_Laser_Light'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='Advanced_Laser_Light' ORDER BY id ASC") or die("Error 3");
