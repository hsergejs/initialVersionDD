...
<? if (stristr($_SERVER['PHP_SELF'],"Donnybrook_Fair.php")) { 
...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='Donnybrook_Fair'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='Donnybrook_Fair'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='Donnybrook_Fair' ORDER BY id ASC") or die("Error 3");
