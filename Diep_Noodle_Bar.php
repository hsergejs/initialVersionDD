...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='Diep_Noodle_Bar'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='Diep_Noodle_Bar'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='Diep_Noodle_Bar' ORDER BY id ASC") or die("Error 3");
