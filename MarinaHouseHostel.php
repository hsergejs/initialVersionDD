...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='MarinaHouseHostel'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='MarinaHouseHostel'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='MarinaHouseHostel' ORDER BY id ASC") or die("Error 3");
