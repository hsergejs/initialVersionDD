...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='The_Wright_Venu'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='The_Wright_Venu'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='The_Wright_Venu' ORDER BY id ASC") or die("Error 3");
