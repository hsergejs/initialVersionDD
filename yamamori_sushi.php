...
$result = mysql_query ("SELECT * FROM ltd_page WHERE sh_name='yamamori_sushi'",$db);
if (!$result)
{
...
//RATING SCRIPT
$queryr = mysql_query ("SELECT * FROM rating WHERE sh_name='yamamori_sushi'");
...
//END RATING SCRIPT
//COMMENT SCRIPT
$queryget = mysql_query ("SELECT * FROM comments WHERE sh_name='yamamori_sushi' ORDER BY id ASC") or die("Error 3");
